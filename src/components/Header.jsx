...
const Header = () => {
  ...
  return (
    <header className='p-4 flex justify-between items-center'>
      ...
      <img className='w-[50px]' src="/youtube_icon.png" alt="logo" />
      <h1 className='text-2xl max-sm:hidden font-mono'>Youtube</h1>
      </Link>

      <form onSubmit={handleSubmit} className='group flex border-gray-400 rounded-[20px] overflow-hidden'>
        <input className='group-hover:border-blue-500 bg-black border border-transparent px-5 py-2 outline-none rounded-1-[20px] focus:border-blue-500' type="text" placeholder='Ara...' />
